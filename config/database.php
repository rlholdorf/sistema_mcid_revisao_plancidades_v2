    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'schema' => '_tabelas_dominios',
            'sslmode' => 'prefer',
        ],
        'pgsql_corp' => [
            'driver' => 'pgsql',
            'host' => env('DB_HOST_CORP', '127.0.0.1'),
            'port' => env('DB_PORT_CORP', '5432'),
            'database' => env('DB_DATABASE_CORP', 'forge'),
            'username' => env('DB_USERNAME_CORP', 'forge'),
