    ...
    <div>
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col col-xs-12 col-sm-12">
                    <div class="p-3 text-right">
                        ...
                        @click="IrParaPagina('/plancidades/revisao/projeto/' + dadosRevisao.id + '/criar')">
                            Editar
                        </button>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col col-xs-12 col-sm-12">
                    <div class="p-3 text-right">
                        <button class="br-button primary mr-3" @click="IrParaPagina('/plancidades/revisao/etapas/projeto/' + dadosRevisao.id + '/criar')"
                ...
                <div class="col col-xs-12 col-sm-12">
                    <div class="p-3 text-right">
                        <button class="br-button success mr-3" :disabled="this.situacao_revisao_id == '3' || this.situacao_revisao_id == '5' || this.situacao_revisao_id == '6'" 
                            ...
                            :href="'/plancidades/revisao/projeto/listar/' + this.dadosProjeto.id">Voltar
                            </a>
                    </div>
                </div>
            </div>
...
<script>
export default {
    props: ['url', 'dadosProjeto', 'dadosRevisao', 'dadosProjetoRevisao', 'dadosEtapas', 'dadosEtapasRevisao', 'situacaoRevisao'],
    data() {
        return {
        //----Campos Select
            cargos:'',
