            ...
            <div class="row">
                <div class="col col-xs-12 col-sm-12">
                    <div class="p-3 text-right">
                        ...
                        @click="IrParaPagina('/plancidades/revisao/objetivo_estrategico/' + dadosRevisao.id + '/criar')">
                            Editar
                        </button>
                    </div>
                </div>
...
Nordeste: Meta para 2025: 103 - Meta para 2026: 88 - Meta para 2027: 43">
            ...
            <div class="row">
                <div class="col col-xs-12 col-sm-12">
                    <div class="p-3 text-right">
                        <button class="br-button primary mr-3" :disabled="this.situacao_revisao_id == '3' || this.situacao_revisao_id == '5' || this.situacao_revisao_id == '6'"
                        @click="IrParaPagina('/plancidades/revisao/meta/objetivo_estrategico/' + dadosRevisao.id + '/criar')">
                            Editar
                        </button>
                    </div>
                </div>
            ...
            <div v-if="dadosIndicador.bln_meta_regionalizada">
                <div class="row mt-3">
                ...
                <div class="col col-xs-12 col-sm-12">
                    <div class="p-3 text-right">
                        <div class="p-3 text-right">
                            ...
                            :href="'/plancidades/revisao/objetivo_estrategico/listar/' + this.dadosIndicador.id">Voltar
                            </a>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        IrParaFinalizacao(revisaoId){
            window.location.href = "/plancidades/revisao/objetivo_estrategico/finalizar/"+revisaoId;
        }
