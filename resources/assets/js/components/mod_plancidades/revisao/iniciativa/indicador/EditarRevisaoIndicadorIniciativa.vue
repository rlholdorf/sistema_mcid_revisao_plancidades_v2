        ...
        <div class="form-group">
            ...
            <div class="row mt-3">
                ...
                <div class="column col-6 col-xs-12 br-textarea">
                    <label>Nova Unidade de Medida</label>
                        ...
                        v-model="dadosIndicadorIniciativaRevisao.unidade_medida_id">
            ...
            <div class="row mt-3">
                <div class="column col-6 col-xs-12">
                    ...
                    <p v-text="dadosIniciativa.txt_periodo_ou_data"></p>
                </div>
                ...
                <div class="column col-6 col-xs-12 br-textarea">
                    <label>Novo Período ou Data a que se Refere o Indicador</label>
                        ...
                        :value="dadosIndicadorIniciativaRevisao.txt_periodo_ou_data">
                        </textarea>
                </div>
            </div>
            ...
            <div class="row mt-3">
                ...
                <div class="column col-6 col-xs-12 br-textarea">
                    <label>Nova Periodicidade</label>
                        ...
                        v-model="dadosIndicadorIniciativaRevisao.periodicidade_id">
            ...
            <div class="row mt-3">
                ...
                <div class="column col-6 col-xs-12 br-textarea">
                    ...
                    v-model="dadosIndicadorIniciativaRevisao.polaridade_id"> <!-- Não funcionou-->
            ...
            <div class="row mt-3" >
                <div class="col col-xs-12 br-textarea">
                    ...
                    <textarea required class="input-medium" id="txt_justificativa_revisao_indicador_iniciativa" name="txt_justificativa_revisao_indicador_iniciativa" rows="2"
                    v-model="dadosIndicadorIniciativaRevisao.txt_justificativa_revisao_indicador_iniciativa">
                    </textarea>
...
<script>
export default {
    props: ['url', 'dadosRevisao', 'dadosIniciativa', 'revisaoCadastrada', 'dadosIndicadorIniciativaRevisao', 'dadosMetaRevisao'],
    data() {
        return {
        //----Campos Select
    ...
    mounted() {
        ...
        console.log(this.dadosIndicadorIniciativaRevisao);
    }
}
</script>
