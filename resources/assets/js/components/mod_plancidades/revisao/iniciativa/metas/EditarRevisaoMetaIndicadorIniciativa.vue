    ...
    <div>
        ...
        <div class="form-group">
            ...
            <div class="row mt-3">
                ...
                <textarea class="input-medium" id="txt_regionalizacao_nova" name="txt_regionalizacao_nova" rows="5" v-model="dadosMetaRevisao.txt_regionalizacao_nova" placeholder=
"Exemplo: 
...
Nordeste: Meta para 2025: 103 - Meta para 2026: 88 - Meta para 2027: 43">
            ...
            <div class="row mt-3" >
                <div class="col col-xs-12 br-textarea">
                    ...
                    <textarea required class="input-medium" id="txt_justificativa_revisao_meta_iniciativa" name="txt_justificativa_revisao_meta_iniciativa" rows="2"
