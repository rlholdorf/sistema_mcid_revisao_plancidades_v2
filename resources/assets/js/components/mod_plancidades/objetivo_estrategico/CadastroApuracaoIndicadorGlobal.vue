<template>
    <div class="form-group">            
        <div class="row mt-3" v-if="this.meta_indicador">   
            <div class="titulo">
            ...
            <div class="col col-xs-12 col-sm-3 br-input">
                ...
                <input id="vlr_esperado_ano_1" 
                    ...
                    :value="this.meta_indicador.vlr_esperado_ano_1"                 
                    disabled>
            </div>
            <div class="col col-xs-12 col-sm-3 br-input">
                ...
                <input id="vlr_esperado_ano_2" 
                    ...
                    :value="this.meta_indicador.vlr_esperado_ano_2"                 
                    disabled>
            </div>  
            <div class="col col-xs-12 col-sm-3 br-input">
                ...
                <input id="vlr_esperado_ano_3" 
                    ...
                    :value="this.meta_indicador.vlr_esperado_ano_3"                 
                    disabled>
            </div>
            <div class="col col-xs-12 col-sm-3 br-input">
                ...
                <input id="vlr_meta_final_cenario_atual" 
                    ...
                    :value="this.meta_indicador.vlr_meta_final_cenario_atual"                 
                    disabled>
            </div>                   
        </div>
        <div class="row mt-3"  v-if="this.meta_indicador">                    
            ...
            <div class="col col-xs-12 col-sm-4 br-input">
                ...
                <input id="vlr_apurado_global" 
                    type="number" 
                    name="vlr_apurado_global"
                    step="0.01"
                    v-model.number="vlr_apurado_global"
                    required
                >
            </div>
        </div>
...
<script>
    export default {
        props: ['url', 'meta_indicador','dsc_periodo_monitoramento','num_ano_periodo_monitoramento'],
        data() {
            return {          
                vlr_apurado_global:'',
            }
