...
<div class="main-content pl-sm-3 mt-5" id="main-content">
    ...
    <p>
        ...
        (<a href="https://www.gov.br/cidades" target="_blank"> Ministério das Cidades</a>).
    </p>
    <form id="form_cad_proposta_mcmv" class="form-horizontal" role="form" method="POST" action='{{ url("proposta/mcmv/salvar") }}'>         
        {{ csrf_field() }}
        ...
        <input type="hidden" id="selecao_id" name="selecao_id" value="6">  
