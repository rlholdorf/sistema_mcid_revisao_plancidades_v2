<div class="row">
        ...
        <div class="row">
            <div class="col col-xs-12 col-sm-12 br-input input-highlight">        
                <p><strong>7. Atende critérios da Politíca Nacional de Saneamento Básico?</strong></p>
                <input id="input-highlight-labeless" type="text" placeholder="Placeholder" value="@if($proposta->bln_criterios_pnsa) Sim @else Não @endif"/>
                <span class="br-divider my-3">
            </div>    
