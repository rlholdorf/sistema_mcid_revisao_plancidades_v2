                    ...
                    <tbody>
                        ...
                        <tr class="text-center ">
                            ...
                            <td class="text-center">
                                {{number_format($dados->num_contratos_ativos_transferegov, 0, ',' , '.')}}</td>
                            <td class="text-center">
                                {{number_format($dados->num_contratos_inativos_transferegov, 0, ',' , '.')}}</td>
                            <td class="text-center">
                                {{number_format($dados->num_contratos_ativos_db_gestores, 0, ',' , '.')}}</td>
                            <td class="text-center">
                                {{number_format($dados->num_contratos_inativos_db_gestores, 0, ',' , '.')}}</td>
