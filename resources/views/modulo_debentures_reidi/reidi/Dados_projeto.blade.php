...
<historico-navegacao
      ...
      :telanterior02="'Consultar Reidi'"      
      :telanterior03="'Lista Reidi'"      
...
<div class="main-content pl-sm-3 mt-5 container-fluid" id="main-content" >
  ...
  <cabecalho-relatorios
            ...
            :linkcompartilhar="'{{ url("/debentures_reidi/projeto/reidis/".$projeto->id) }}'"
  ...
  <form role="form" method="POST" action='{{ url("debentures_reidi/projeto/reidis/update") }}'>
    @csrf
                  ...
                  @foreach($estados as $dados) 
                           ...
                           <tr class="text-center" >
                              ...
                              <td class="p-3 text-center">
                                <botao-acao-icone  
                                  :url="'{{ url("/debentures_reidi/projeto/reidis/excluir")}}'" 
                                  registro="{{$dados->id}}"                               
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" method="POST" action='{{ url("debentures_reidi/estado/reidis/add") }}'>
          @csrf
          <input type="hidden" id="projeto_id" name="projeto_id" value="{{$projeto->id}}">
              <add-estado 
              :url="'{{ url('/') }}'"
