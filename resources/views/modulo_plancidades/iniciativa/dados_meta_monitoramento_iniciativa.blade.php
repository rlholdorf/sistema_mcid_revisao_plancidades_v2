...
<div class="main-content pl-sm-3 mt-5 container-fluid" id="main-content">
    ...
    <cabecalho-relatorios :botaoEditar='false' titulo="Editar Monitoramento da Regionalização"     
        subtitulo1="{{$dados_meta_monitoramento->txt_enunciado_iniciativa}}"
    ...
    <form role="form" method="POST" action='{{ route('plancidades.apuracaoMetaIniciativa.atualizar', ['regionalizacaoMetaId' => $dados_meta_monitoramento->id]) }}'>
        @csrf
            ...
            <div class="row mt-3">
                <div class="col col-xs-12">
                    <div class="br-input">
                        ...
                        <input id="input-default" type="text" placeholder="Placeholder" value="{{$dados_meta_monitoramento->metaIniciativa->txt_dsc_meta}}" disabled="true" />                    
                    </div>                    
                </div>
            </div>  
            <div class="row mt-3">
                <div class="col col-xs-12">
                    <div class="br-input">
                        ...
                        <input id="input-default" type="text" placeholder="Placeholder" value="{{$dados_meta_monitoramento->regionalizacaoMetaIniciativa->regionalizacao->txt_regionalizacao}}" disabled="true" />                    
                      </div>
            ...
            <div class="row mt-3">   
                ...
                <div class="col col-xs-12 col-sm-3 br-input">
                    ...
                    <input id="vlr_esperado_ano_1" 
                        ...
                        value="{{$dados_meta_monitoramento->regionalizacaoMetaIniciativa->vlr_esperado_ano_1}}"                 
                        disabled>
                </div>
                <div class="col col-xs-12 col-sm-3 br-input">
                    ...
                    <input id="vlr_esperado_ano_2" 
                        ...
                        value="{{$dados_meta_monitoramento->regionalizacaoMetaIniciativa->vlr_esperado_ano_2}}"                 
                        disabled>
                </div>  
                <div class="col col-xs-12 col-sm-3 br-input">
                    ...
                    <input id="vlr_esperado_ano_3" 
                        ...
                        value="{{$dados_meta_monitoramento->regionalizacaoMetaIniciativa->vlr_esperado_ano_3}}"                 
                        disabled>
                </div>
                <div class="col col-xs-12 col-sm-3 br-input">
                    ...
                    <input id="vlr_meta_final_cenario_atual" 
                        ...
                        value="{{$dados_meta_monitoramento->regionalizacaoMetaIniciativa->vlr_meta_final_cenario_alternativo}}"                 
                        disabled>
                </div>                   
            </div>
            <div class="row mt-3" >
                <div class="col col-xs-12 col-sm-3 br-input">
                    ...
                    <input id="dsc_periodo_monitoramento" 
                        ...
                        value="{{$dados_meta_monitoramento->monitoramentoIniciativa->periodoMonitoramento->dsc_periodo_monitoramento}}"                 
                        disabled>
                </div>
                <div class="col col-xs-12 col-sm-3 br-input">
                    <label>Ano</label>
                    <input id="num_ano_periodo_monitoramento" 
                        ...
                        value="{{$dados_meta_monitoramento->monitoramentoIniciativa->num_ano_periodo_monitoramento}}"                 
                        disabled>
                </div>

                <div class="col col-xs-12 col-sm-3 br-input">
                    {{-- div apenas para espaçamento --}}
                </div>
