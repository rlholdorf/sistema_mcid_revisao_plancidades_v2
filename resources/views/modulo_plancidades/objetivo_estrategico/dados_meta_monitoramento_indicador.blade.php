...
<div class="main-content pl-sm-3 mt-5 container-fluid" id="main-content">
    ...
    <form role="form" method="POST" action='{{ route('plancidades.apuracaoMetaIndicador.atualizar', ['regionalizacaoMetaId' => $dados_meta_monitoramento->id]) }}'>
        @csrf
            ...
            <div class="row mt-3">
                <div class="col col-xs-12">
                    <div class="br-input">
                        ...
                        <p>{{$dados_meta_monitoramento->metaIndicador->txt_dsc_meta}}</p>
                    </div>                    
                </div>
            </div>  
            <div class="row mt-3">
                <div class="col col-xs-12">
                    <div class="br-input">
                        ...
                        <p>{{$dados_meta_monitoramento->regionalizacaoMetaIndicador->regionalizacao->txt_regionalizacao}}</p>
                      </div>
                </div>
            </div> 
