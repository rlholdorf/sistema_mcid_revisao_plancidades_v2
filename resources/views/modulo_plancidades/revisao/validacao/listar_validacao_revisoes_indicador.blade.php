...
<historico-navegacao :url="'{{ url('/home') }}'" 
    ...
    :telatual="'Lista de Revisões de Indicadores'">
</historico-navegacao>
                            ...
                            @foreach ($revisoes as $revisao)
                                ...
                                <tr class="conteudoTabela">
                                    ...
                                    <td class="text-center acao"><a class="br-button circle primary small"
                                        href='{{ route("plancidades.revisao.objetivoEstrategico.show", ['revisaoId' => $revisao->revisao_indicador_id]) }}' target="_blank">
                                        <i class="fas fa-eye"></i></a></td>
                                    <td class="text-center acao"><a class="br-button circle primary small"
                                        href='{{ route("plancidades.revisao.validacao.indicadores.editar", ['revisaoIndicadorid' => $revisao->revisao_indicador_id]) }}'>
