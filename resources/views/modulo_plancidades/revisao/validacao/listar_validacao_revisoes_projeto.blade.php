...
<historico-navegacao :url="'{{ url('/home') }}'" 
    ...
    :telatual="'Lista de Revisões de Projetos'">
</historico-navegacao>


<div class="main-content pl-sm-3 mt-5 container-fluid" id="main-content">

    <cabecalho-relatorios :titulo="'Lista de Revisões de Projetos'" :linkcompartilhar="'{{ url('/') }}'" :barracompartilhar="false">
                            ...
                            @foreach ($revisoes as $revisao)
                                <tr class="conteudoTabela">
                                    ...
                                    <td class="text-center acao"><a class="br-button circle primary small"
                                        href='{{ route("plancidades.revisao.projeto.show", ['revisaoId' => $revisao->revisao_projeto_id]) }}' target="_blank">
                                        <i class="fas fa-eye"></i></a></td>
                                    <td class="text-center acao"><a class="br-button circle primary small"
                                        href='{{ route("plancidades.revisao.validacao.projetos.editar", ['revisaoProjetoid' => $revisao->revisao_projeto_id]) }}'>
