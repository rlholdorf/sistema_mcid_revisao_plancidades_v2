...
@section('content')
    ...
    <div class="main-content pl-sm-3 mt-5 container-fluid" id="main-content">
        ...
        <form role="form" method="POST" action='{{ route("plancidades.revisao.regionalizacao.objetivoEstrategico.atualizar",['revisaoId'=> $revisaoCadastrada->revisao_indicador_id]) }}'>
            @csrf
