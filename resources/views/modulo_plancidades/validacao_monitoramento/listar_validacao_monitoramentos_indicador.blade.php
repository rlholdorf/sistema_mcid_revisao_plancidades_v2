...
<historico-navegacao :url="'{{ url('/home') }}'" 
    ...
    :telatual="'Lista de Monitoramento de Indicadores'">
</historico-navegacao>
                            ...
                            @foreach ($monitoramentos as $monitoramento)
                                ...
                                <tr class="conteudoTabela">
                                    ...
                                    <td class="text-center acao"><a class="br-button circle primary small"
                                        href='{{ route("plancidades.monitoramentos.objetivoEstrategico.show", ['indicadorId' => $monitoramento->monitoramento_indicador_id]) }}' target="_blank"><i
                                            class="fas fa-eye"></i></a></td>
                                    <td class="text-center acao"><a class="br-button circle primary small" 
                                        href='{{ route("plancidades.monitoramentos.validacao.indicadores.editar", ['situacaomonitoramentoId' => $monitoramento->monitoramento_indicador_id]) }}'><i
