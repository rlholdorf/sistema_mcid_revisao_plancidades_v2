...
@section('content')
    ...
    <historico-navegacao :url="'{{ url('/home') }}'" 
        :telanterior03="'Lista de Monitoramento de Iniciativas'"
        :link3="'{{url('/plancidades/monitoramentos/validacao/iniciativa/listarMonitoramentos')}}'"
    ...
    <div class="main-content pl-sm-3 mt-5 container-fluid" id="main-content">
        ...
        <cabecalho-relatorios :botaoEditar='false' titulo="{{$dados_monitoramento->txt_enunciado_iniciativa}}" 
        ...
        <hr>
        <form role="form" method="POST" action='{{ route("plancidades.monitoramentos.validacao.iniciativas.atualizar",['monitoramentoIniciativaid'=> $monitoramentos->monitoramento_iniciativa_id]) }}'>
            @csrf
            <altera-situacao-monitoramento-iniciativa 
                ...
                :meta-iniciativa="{{json_encode($metaIniciativa)}}"
