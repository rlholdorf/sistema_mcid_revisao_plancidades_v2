...
<historico-navegacao :url="'{{ url('/home') }}'" 
    ...
    :telatual="'Lista de Monitoramento de Projetos'">
</historico-navegacao>


<div class="main-content pl-sm-3 mt-5 container-fluid" id="main-content">

    <cabecalho-relatorios :titulo="'Lista de Monitoramento de Projetos'" :linkcompartilhar="'{{ url('/') }}'" :barracompartilhar="false">
                        ...
                        @foreach ($monitoramentos as $monitoramento)
                            ...
                            <tr class="conteudoTabela">
                                ...
                                <td class="text-center acao"><a class="br-button circle primary small"
                                    href='{{ route("plancidades.monitoramentos.projeto.show", ['monitoramentoId' => $monitoramento->monitoramento_projeto_id]) }}' target="_blank"><i
                                        class="fas fa-eye"></i></a></td>
                                <td class="text-center acao"><a class="br-button circle primary small" 
                                    href='{{ route("plancidades.monitoramentos.validacao.projetos.editar", ['monitoramentoId' => $monitoramento->monitoramento_projeto_id]) }}'><i
    ...
    <div class="p-3 text-right">
        ...
        <a class="br-button danger mr-3" href="{{url('plancidades/monitoramentos/validacao/consulta')}}">Voltar
        </a>
    </div>
